...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto", className)}>
      {/* FIXED: no more render prop */}
      <ComboboxPrimitive.Input
        data-slot="combobox-input"
        disabled={disabled}
        className={cn(
          "h-8 w-full min-w-0 border-0 bg-transparent px-2.5 py-1 text-sm outline-none shadow-none ring-0 focus-visible:ring-0 disabled:bg-transparent",
        )}
        {...props}
      />
